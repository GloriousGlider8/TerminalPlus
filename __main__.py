                        ...
                        with open("ignore") as ign:
                            ...
                            for v in compare:
                                if v.isnumeric():
                                    ...
                                    if v == "f":
                                        num = False
                                        print(f"{c.Fore.YELLOW}~{numVal}{c.Style.RESET_ALL} ", end="")
                                    elif v == "i":
                                        num = False
                                        print(f"{c.Fore.GREEN}+{numVal}{c.Style.RESET_ALL} ", end="")
                                    elif v == "d":
                                        num = False
                                        print(f"{c.Fore.RED}-{numVal}{c.Style.RESET_ALL} ", end="")
                            print()
