                ...
                if args[1] == "commit":
                    ...
                    if os.system(f"git commit -a -m \"Generated by T+ DEV: {input("[string] Commit message: ")}\"") == 0:
                        if input("[true / false] force changes: ") == "true":
                            if os.system("git push origin dev --force") == 0:
                                print(f"{c.Fore.GREEN}Successfully opened a pull request to dev branch!{c.Style.RESET_ALL}")
                            else:
                                print(f"{c.Fore.RED}Failed to push changes!{c.Style.RESET_ALL}")
                        else:
                            if os.system("git push origin dev") == 0:
                                print(f"{c.Fore.GREEN}Successfully opened a pull request to dev branch!{c.Style.RESET_ALL}")
                            else:
                                print(f"{c.Fore.RED}Failed to push changes!{c.Style.RESET_ALL}")
